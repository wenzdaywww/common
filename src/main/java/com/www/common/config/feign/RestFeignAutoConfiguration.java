...
import com.www.common.config.feign.core.FeignHystrixStrategy;
...
/**
 * <p>@Description Rest及feign自动配置类 </p>
 * <p>@Version 1.0 </p>
 * <p>@Author www </p>
...
public class RestFeignAutoConfiguration {
     ...
     * <p>@Author www </p>
     * <p>@Date 2022/3/22 21:08 </p>
     * @return com.www.common.config.feign.FeignHystrixStrategy
     */
    @Bean
    @ConditionalOnClass(HystrixConcurrencyStrategy.class)
    public FeignHystrixStrategy feignHystrixStrategy(){
        return new FeignHystrixStrategy();
    }
    /**
